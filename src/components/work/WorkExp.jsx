    ...
    <ol className="flex flex-col md:flex-row pt-9 relative border-l border-stone-200">
      <li className="mb-10 ml-4">
        ...
        <p className="flex flex-wrap gap-4 flex-row items-center justify-start text-xs md:text-sm">
          <span className="inline-block px-4 py-1.5 text-lg font-bold bg-[#facc15] text-[#18181b] rounded-md">{year}</span>
          <span className="text-2xl font-bold text-[#f1f5f9]/90">{title},</span>
          <span className="text-base font-semibold italic text-[#facc15]">{company},</span>
